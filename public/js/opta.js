...
var yAxisPlot = d3.svg.axis()
 ...
 //*******************************************************************************************************//                          
  ...
  //Api call
  d3.json("/providers/opta.json", function(error, data) {
    events = data;
    updateChart();
  });
  ...
  function updateChart() {
    points = [];
    xScale.domain(d3.extent(events, function(d) { return d.x; }))
    yScale.domain(d3.extent(events, function(d) { return d.y; }))
    xAxis.scale(xScale);
