...
(function() {
  var GeoChart, HexChart, HexContainer, geoChart, renderContainer, renderMap,
  ...
  HexChart = (function() {
    ...
    function HexChart(data, geo, container, indicator, yPosition) {
      ...
      this.xAxis = d3.svg.axis().scale(this.xScale).ticks(7).tickSize(10).tickPadding("10").orient("bottom");
    ...
    HexChart.prototype.render = function() {
      ...
      this.text.text(this.data[0].drg);
  ...
  GeoChart = (function() {
    ...
    function GeoChart(topology, div) {
      ...
      this.projection = d3.geo.albersUsa().scale(1200).translate([550, 330]);
    ...
    GeoChart.prototype.render = function() {
      ...
      return this.states = this.svg.selectAll("path").data(geometries).enter().append("path").attr("d", this.path);
    };
    ...
    GeoChart.prototype.renderProviders = function(providers) {
      ...
      }).on("mousedown", this.mouseDown).on("mouseup", this.mouseUp).attr("r", 4).attr("cx", function(d, i) {
